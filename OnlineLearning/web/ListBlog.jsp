    ...
    <body>
        ...
        <div class="navbar1">
            <div class="container3">
                ...
                <span class="navbar1-brand"><a href="bloglist">List Blog</a></span>
            </div>
        </div>
        <div class="container3" >
            <div class="row">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widgetre" style="">
                                ...
                                <ul style=" margin: 10px; padding: 10px; display:flex" >
                                    <a style="text-decoration: none; border: 1px solid black; border-radius: 5px;" href="bloglist?sortOrder=ASC">Sort A-Z</a>
                                    <a style="text-decoration: none; border: 1px solid black; border-radius: 5px;" href="bloglist?sortOrder=DESC">Sort Z-A</a>
                                    <a style="text-decoration: none; border: 1px solid black; border-radius: 5px;" href="bloglist?sortOrder=CreateDESC">Sort New Blog</a>
                                    <a style="text-decoration: none; border: 1px solid black; border-radius: 5px;" href="bloglist?sortOrder=CreateASC">Sort Old Blog</a>
